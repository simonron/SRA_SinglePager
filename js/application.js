					jQuery(document).ready(function ($) {
						...
						function sra_menu(move_this) {
							...
							displayed_content_width=$(displayed_content ).width();
								//console.log(displayed_content_left + " left is " + displayed_content_left);
							
							displayed_content_left = $(displayed_content).offset().left;
							
							console.log(pageWidth + " pageWidth " + displayed_content_width+"displayed_content_width");
							
							left_offset=(pageWidth-displayed_content_width)/2;
							
							move_here_y = (displayed_content_top - display_here_top);
							//move_here_x = (displayed_content_left - displayed_content_left);
							...
							if ($(displayed_content).css("transform") == 'none') {
								...
								//$(displayed_content).css("border-left", "25vw");
								move_here_y=-97;
								$(displayed_content).css("transform", "translate("+left_offset+"px,"+move_here_y+"px)"); // moves current piece up from original place to just under menu at the top
